...
public class HSharedObject
{
    ...
    */
   static HSharedObject filledSharedObjectHints(final StructuredPDFInfo info,
                                                final PDFObjectQueue    queue,
                                                final long              first_shared_offset)
   {
      ...
      sharedObjectHints.nbits_delta_group_length = nbits((int)max_length - (int)min_length);
      for (int i = 0; i < info.sharedObjectData.nshared_total; ++i)
      {
         // Adjust deltas
    ...
    */
   void writeHSharedObject(final BitWriter w)
      throws IOException
   {
      ...
      for (final HSharedObject.HSharedObjectEntry en : entries)
      {
