   ...
   implements Serializable
{
    ...
    */
   VirtualPart(final byte[] hardPart,
               final long   outBeginPos)
   {
      this.reference       = null;
    ...
    */
   public VirtualPart(final String reference,
                      final long   referenceBeginPosition,
                      final int    referenceLength)
   {
    ...
    *                               deflated PDF
    */
   VirtualPart(final String reference,
               final long   referenceBeginPosition,
               final int    referenceLength,
               final long   outBeginPos)
   {
   ...
   byte[] getReferenceBytes()
   {
      ...
      {
         this._referenceBytes = this.reference.getBytes(Charsets.UTF_8);
      }
